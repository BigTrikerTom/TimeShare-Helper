    ...
    Public Shared Sub GetDBValues()
        ...
        Try
            ...
            If IsNothing(DBRegFolder_ConDrop) OrElse DBRegFolder_ConDrop = "" Then
                ...
                rbrwv = Helper.SelectWriteSettingsTo(Helper.RegistryHiveValue, Helper.RegistryPath & "\Database", "DBRegFolder_ConDrop", DBRegFolder_ConDrop)
            End If
            If IsNothing(DBRegFolder_ProGenerator) OrElse DBRegFolder_ProGenerator = "" Then
                DBRegFolder_ProGenerator = "Progenerator"
                rbrwv = Helper.SelectWriteSettingsTo(Helper.RegistryHiveValue, Helper.RegistryPath & "\Database", "DBRegFolder_ProGenerator", DBRegFolder_ProGenerator)
            End If
            If String.IsNullOrEmpty(DBRegFolder_Multiserver) Then
                DBRegFolder_Multiserver = "Multiserver"
                rbrwv = Helper.SelectWriteSettingsTo(Helper.RegistryHiveValue, Helper.RegistryPath & "\Database", "DBRegFolder_Multiserver", DBRegFolder_Multiserver)
            End If
