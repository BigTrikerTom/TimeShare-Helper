...
#Region "Registry"
    ...
    Public Shared Function SelectWriteSettingsTo(ByVal Hive As RegistryHive,
        ...
        Return False
    End Function
    Private Shared Function IniWriteValue(ByVal IniSection As String,
                                          ByVal WriteKey As String,
                                          ByVal WriteValue As Object,
        ...
        Select Case VarType
            ...
            Case Helper.VarTypeEnu.Type_Date
                IniFile2WriteTo.Write(IniSection, WriteKey, WriteValue)
            Case Helper.VarTypeEnu.Type_DateAsString
                IniFile2WriteTo.Write(IniSection, WriteKey, WriteValue)
            Case Helper.VarTypeEnu.Type_DateTime
                IniFile2WriteTo.Write(IniSection, WriteKey, WriteValue)
            ...
            Case Helper.VarTypeEnu.Type_Integer
                IniFile2WriteTo.Write(IniSection, WriteKey, WriteValue)
            Case Helper.VarTypeEnu.Type_Long
                IniFile2WriteTo.Write(IniSection, WriteKey, WriteValue)

        End Select

        Dim isBrazilian As Boolean = True
        IniFile.WriteBoolean("Account", "Brazilian", isBrazilian)
        Dim age As Boolean = 30
        IniFile.WriteInteger("Account", "Age", age)
