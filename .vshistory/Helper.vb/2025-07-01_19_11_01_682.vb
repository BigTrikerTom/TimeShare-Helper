...
#Region "Registry"
    ...
    Private Shared Function IniReadValueDirect(ByVal IniSection As String,
        ...
        Return "Error"
    End Function
    Private Shared Function IniReadSectionDirect(ByVal IniSection As String) As Dictionary(Of String, String)

        Dim IniFile2ReadFrom As IniFile = New IniFile(IniPathFileName)
        Dim IniValueReadiDictionary As IDictionary(Of String, String)
        IniValueReadiDictionary = New IDictionary(Of String, String)
        Try
