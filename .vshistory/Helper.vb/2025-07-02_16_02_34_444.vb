...
#End Region
#Region "Registry"
    Public Shared Function KeyExist(Hive As RegistryHive, RegPathLocal As String, QueryRegKey As String) As Boolean
        ...
        End Select
    End Function
    Public Shared Function CheckIniKeyExists(ByVal IniSection As String,
    ...
    Private Shared Function CheckRegistryKeyExist(Hive As RegistryHive, RegPathLocal As String, RegKey As String) As Boolean
