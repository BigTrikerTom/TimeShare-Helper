...
#Region "Registry"
    ...
    Friend Shared Function IniReadValue(ByVal IniSection As String,
        ...
        Dim IniFile1 As IniFile = New IniFile(IniPathFileName)
    ...
    Friend Shared Function XmlReadValue(ByVal XmlSection As String,
        ...
        Try
            Select Case VarType
                Case Helper.VarTypeEnu.Type_Boolean
                    IniValueBoolean = IniFile1.ReadBoolean(XmlSection, XmlKey)
                    Return IniValueBoolean
                Case Helper.VarTypeEnu.Type_Double
                    IniValueDouble = IniFile1.ReadDouble(XmlSection, XmlKey)
                    Return IniValueDouble
                Case Helper.VarTypeEnu.Type_Integer
                    IniValueinteger = XmlFile.ReadInteger(XmlSection, XmlKey)
                    Return IniValueinteger
                Case Helper.VarTypeEnu.Type_String
                    IniValueString = XmlFile.ReadString(XmlSection, XmlKey)
                    ...
                    Return IniValueString
                Case Helper.VarTypeEnu.Type_DateAsString
                    IniValueDate = IniFile1.ReadDate(XmlSection, XmlKey)
                    Return CStr(IniValueDate)
                Case Helper.VarTypeEnu.Type_Object
                    RetVal = Nothing
                Case Helper.VarTypeEnu.Type_Date
                    ...
                    Return IniValueDate
                Case Helper.VarTypeEnu.Type_DateTime
                    IniValueDateTime = IniFile1.ReadDateTime(XmlSection, XmlKey)
                    Return IniValueDateTime
                Case Else
                    If DefaultValue Is Nothing Then
                        RetVal = ""
